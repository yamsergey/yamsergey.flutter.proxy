...
/** PlatformProxyPlugin */
public class PlatformProxyPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "platform_proxy");
    channel.setMethodCallHandler(this);
  }

  @Override
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    if (call.method.equals("getPlatformProxy")) {
      String url = call.<String>argument("url");
